...
class GPT2Tokenizer(PreTrainedTokenizer):
    ...
    def __init__(self, vocab_file, merges_file, errors='replace', unk_token="<|endoftext|>",
                 bos_token="<|bos|>", eos_token="<|endoftext|>", pad_token="<|pad|>", **kwargs):
        super(GPT2Tokenizer, self).__init__(bos_token=bos_token, eos_token=eos_token, unk_token=unk_token, pad_token=pad_token, **kwargs)
        # self.max_len_single_sentence = self.model_max_length # no default special tokens - you can update this value if you add special tokens
        # self.max_len_sentences_pair = self.model_max_length # no default special tokens - you can update this value if you add special tokens
